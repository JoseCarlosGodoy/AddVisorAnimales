...
public class VisorAnimalesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        obListAnimales.add(new Animal("Perro","image/perro_1.jpg","image/perro_1.jpg"));
        obListAnimales.add(new Animal("Gato","image/gato_1.jpg","image/gato_1.jpg"));
        obListAnimales.add(new Animal("Pajaro","image/pajaro_1.jpg","image/pajaro_1.jpg"));
